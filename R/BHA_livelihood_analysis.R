...
###### form and credentials to get data from kobo using the koboAPI     ######
...
# 
# df_raw <- download_data(form_id, user=u, pwd = pw) %>%
#   filter(
...
#     uuid = "_uuid"
#   )
# write_csv(x=df_raw, file=("outputs/UGA2101a_Rapid_Assessment_on_Livelihood_and_Market_Strengthening_Opportunities_March2021.csv"))
...
# nrow(df_raw)
## make required changes to field data
# remove some surveys
...
######  analysis based on DAP indicators    ######  

######  A.     Demographics ######

## chunck_HH_by_nationality -----------------------------------------------------
...
# % HH animal husbandry for income and subsistence --------------------------------------------

# % HH able to sustain themselves through animal husbandry --------------------------------------------

# % HH challenges animal husbandry --------------------------------------------

# % HH not raising livestock but wanting to  --------------------------------------------

# % HH type of livestock_choice --------------------------------------------

# % HH most useful support in animal husbandry  --------------------------------------------

# % HH engaged in growing crops --------------------------------------------

# % HH subsistence versus cash cropping --------------------------------------------

# % HH Reason for not growing crops --------------------------------------------

# % HH able to sustain themselves through farming --------------------------------------------

# % HH challenges to meeting household needs --------------------------------------------

# % HH by most useful agricultural livelihood support --------------------------------------------

# % HH able to access market --------------------------------------------

# % HH distance to market --------------------------------------------

# % HH challenges access to market --------------------------------------------

# % HH sell goods at market --------------------------------------------

# % HH challenges selling goods --------------------------------------------


######  D.  Support ######

# % HH received livelihoods support --------------------------------------------

# % HH livelihood strengthened --------------------------------------------

# % HH type of livelihood support --------------------------------------------

# % HH no longer using livelihood support --------------------------------------------

# % HH reason for not using --------------------------------------------

# % HH satisfied with support --------------------------------------------
...
# average # of females/males seeking work per HH


# % HH sustaining themselves partially or fully with animals


# % HH sustaining themselves partially or fully by cultivating land


# % HH with whose main livelihood is agriculture
